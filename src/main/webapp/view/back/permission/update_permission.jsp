...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <script type="text/javascript" src="${pageContext.request.contextPath}/static/js/back/permission/update_permssion.js"></script>
  </head>
  ...
  <body>
   <form action="" method="post" target="mainFrame" id="myForm">
		...
		<div align="center" style="border-color: blue;height: 20px;"><span id="errormsg"></span></div>
			<table width="94%" border="0" cellpadding="1" cellspacing="2"
				...
				<tr>
					...
					<td class="tab_input"><input name="permissionCode"
												 id="permissionCode" type="text" size=20
												 class="easyui-input readyOnly_css" readonly="readonly" /></td>
				</tr>
				<tr>
		...
		<div align="center" class="bottom_div">
			<a href="javascript:void(0)" class="easyui-linkbutton" data-options="iconCls:'icon-ok'" id='addButton' onclick="update_permission.update()">&nbsp;保存&nbsp;</a>
