...
<script type="text/javascript"
	src="${pageContext.request.contextPath}/static/js/back/user/update_user.js"></script>
</head>
		...
		<div id="td" style='margin-left: 10px'>
			...
			<table width="94%" border="0" cellpadding="1" cellspacing="2"
				...
				<tr>
					...
					<td class="tab_input"><input name="loginName"
						...
						class="easyui-input"readonly="readonly"/></td>
				...
				<tr>
					...
					<td class="tab_input"><input name="userType"
												 ...
												 class="easyui-combobox" data-options="panelHeight:'120px',valueField:'id',
												 textField:'text',url:'${pageContext.request.contextPath}/back/common/getSelectData?headerCode=userType'" /></td>
				</tr><tr>
				...
				<tr>
					...
					<td colspan="3"><textarea name="address" style="width: 464px;height: 63px;"></textarea>
				</td>
				</tr>
			...
			<div align="center" class="bottom_div">
				<a href="javascript:void(0)" class="easyui-linkbutton"
					...
					onclick="update_user.update()">&nbsp;保存&nbsp;</a>
