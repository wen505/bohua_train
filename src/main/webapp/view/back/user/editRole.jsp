...
<html>
  <head>
	...
	<!-- 本文件的js -->
  	<script type="text/javascript" src="${pageContext.request.contextPath}/static/js/back/user/editRole.js"></script>
  ...
  <div align="center" style="border-color: blue;height: 20px;">
	...
	<div align="center" class="bottom_div" >
			<a href="javascript:void(0)" class="easyui-linkbutton" data-options="iconCls:'icon-ok'" id='save' onclick="editRole.submitClick()">&nbsp;保存&nbsp;</a>
