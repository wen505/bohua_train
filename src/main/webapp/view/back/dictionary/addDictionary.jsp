...
<head>
    ...
    <script type="text/javascript" src="${ctx}/static/js/back/dictionary/addDictionary.js"></script>
</head>
    ...
    <div id="td" style='margin-left: 10px'>
        ...
        <table width="94%" border="0" cellpadding="1" cellspacing="2"
            ...
            <tr>
                ...
                <td class="tab_input"><input name="headerCode"
                                             ...
                                             class="easyui-input" onblur="addDictionary.checkHeaderCode()"  /></td>
            </tr>
            <tr>
        ...
        <div align="center" class="bottom_div">
            <a href="javascript:void(0)" class="easyui-linkbutton"
               ...
               onclick="addDictionary.add()">&nbsp;保存&nbsp;</a>
